...
with fin_app.app_context():
    ...
    # cursor.execute(
    #     '''ALTER TABLE cash_running_bal DROP COLUMN txn_id''')
    # cursor.execute(
    #     '''ALTER TABLE cash_running_bal DROP COLUMN username''')
    # cursor.execute(
    #     '''ALTER TABLE cash_running_bal ADD COLUMN txn_id INTEGER''')
